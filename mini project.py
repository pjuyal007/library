''' library management System . using classes and objects
The class library have the following functions:
...
keep record of which book is issued to whom via a dict as follows:
...
while True:
    ...
    if choice == 1:
      ...
      print(f'Enter your choice from the given option only)
